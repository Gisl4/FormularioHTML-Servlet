...
public class Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<tr><th>Usuario</th><td>" + usuario + "</th></tr>");
            out.println("<tr><th>Password</th><td>" + password + "</th></tr>");
            out.println("<tr><th>Tecnologías</th><td>");
            if (tecnologia != null) {
                out.println(String.join(" / ", tecnologia));
            } else {
                out.println("No se seleccionaron tecnologías.");
            }
            out.println("</td></tr>");
            
            out.println("<tr><th>Género</th><td>" + genero + "</th></tr>");
            out.println("<tr><th>Ocupación</th><td>" + ocupacion + "</th></tr>");
            out.println("<tr><th>Comentarios</th><td>" + comentarios + "</th></tr>");
            out.println("<tr><th>Valor oculto</th><td>" + valorOculto + "</th></tr>");
